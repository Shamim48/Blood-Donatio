...
public class showBlood_donor extends AppCompatActivity {
    ...
    private void loadData() {
        ...
        DocumentReference user = db.collection("All_Blood_Group").document(Blood_group).collection(Gender_intent).document();
        user.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(getApplicationContext(), "Donor Not Found", Toast.LENGTH_SHORT).show();
                }
